...
See [`examples/07-oam-quickstart`](https://github.com/decision-labs/geoai.js/tree/main/examples/07-oam-quickstart) for a minimal Vite + MapLibre demo over Rome imagery.
