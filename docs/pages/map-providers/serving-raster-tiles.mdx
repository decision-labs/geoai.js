...
COG support is real for **input**, but wiring GeoAI.js usually means WMS tiled requests or adding **MapCache** (or similar) in front — more glue than Tileserver RS or Geobase.

**Pros:** Mature, flexible OGC services.  
**Cons:** Extra setup for simple `{z}/{x}/{y}` TMS URLs.
