...
type ProviderParams =
  | { provider: "esri" }
  | { provider: "mapbox"; apiKey: string; style: string }
  | { provider: "geobase"; projectRef: string; apikey: string; cogImagery: string }
  | { provider: "tms"; baseUrl: string; /* … */ }
  | { provider: "wms"; baseUrl: string; layers: string; /* … */ }
  | { provider: "oam"; itemId?: string; mosaic?: boolean }
  | { provider: "google"; apiKey: string; /* … */ };
```

See [Map Providers](/map-providers) for full parameter docs.
#### Returns
