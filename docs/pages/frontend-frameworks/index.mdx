...
### deck.gl
Use deck.gl for basemap tiles and GeoJSON overlays while GeoAI.js runs inference.

- ✅ **Vanilla JS / CDN** demo
- ✅ **TileLayer + BitmapLayer** for satellite basemaps
- ✅ **GeoJsonLayer** for detections and inference bounds
- ✅ Works alongside any GeoAI **map provider**

[Get Started with deck.gl →](/frontend-frameworks/deckgl)
